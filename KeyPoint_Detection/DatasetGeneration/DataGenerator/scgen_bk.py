...
class SCGen:
    ...
    def generate_dataset(self, num_events: int, num_particles_per_event: int | tuple[int, int], parallel: bool | int = False, batch_size: int = 64, progress_bar: bool = True) -> list[dict[str, Any]]:
        """
